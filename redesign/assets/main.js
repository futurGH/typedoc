(() => {
    ...
    var Re = (t) => Y(t, "__esModule", { value: !0 });
    var _e = (t, e) => () => (
            ...
            if ((e && typeof e == "object") || typeof e == "function")
                for (let i of Ce(e))
                    !Oe.call(t, i) &&
                        ...
                        Y(t, i, {
                            get: () => e[i],
                            enumerable: !(n = Ie(e, i)) || n.enumerable,
                        });
            return t;
        },
        De = (t, e) =>
...
`,
            ...
            (t.Index = function (e) {
                ...
                (t.Index.prototype.query = function (e) {
                    ...
                    for (
                        var N = t.Set.complete, _ = t.Set.empty, u = 0;
                        u < this.fields.length;
                        u++
                    ) {
                        var p = this.fields[u];
                        o[p] && (N = N.intersect(o[p])),
                            a[p] && (_ = _.union(a[p]));
                    }
                    var c = Object.keys(n),
                        v = [],
                    ...
                    for (var u = 0; u < c.length; u++) {
                        ...
                        if (!!N.contains(d) && !_.contains(d)) {
                            ...
                            if ((M = P[d]) !== void 0)
                                ...
                                var L = { ref: d, score: O, matchData: n[T] };
                                (P[d] = L), v.push(L);
                            }
                        }
                    }
                    return v.sort(function (we, Se) {
                        return Se.score - we.score;
                    });
                }),
                    ...
                    for (var s = 0; s < i.length; s++) {
                        ...
                        for (var b = 0; b < h.length; b++) {
                            ...
                            for (
                                ...
                                var S = this.metadataWhitelist[p],
                                    w = y.metadata[S];
                                this.invertedIndex[y][o][n][S] == null &&
                                    (this.invertedIndex[y][o][n][S] = []),
                                    this.invertedIndex[y][o][n][S].push(w);
                            }
                        }
                    }
                }),
    ...
    var ae = [];
    function D(t, e) {
        ae.push({ selector: e, constructor: t });
    }
    var J = class {
        constructor() {
    ...
    function Ae(t, e) {
        t.index ||
            (window.searchData &&
                ...
                (t.index = de.Index.load(window.searchData.index))));
    }
    function He(t, e, r, n) {
        if ((Ae(n, t), !n.index || !n.data)) return;
        e.textContent = "";
        let i = r.value.trim(),
            s = n.index.search(`*${i}*`);
        for (let o = 0, a = Math.min(10, s.length); o < a; o++) {
            let u = n.data.rows[Number(s[o].ref)],
                l = me(u.name, i);
            u.parent &&
                (l = `<span class="parent">${me(u.parent, i)}.</span>${l}`);
    ...
    function me(t, e) {
        ...
        for (; o != -1; )
            i.push(
                te(t.substring(s, o)),
                `<b>${te(t.substring(o, o + n.length))}</b>`
            ),
                (s = o + n.length),
                (o = r.indexOf(n, s));
    ...
    var se = class extends k {
            ...
            (this.key = `filter-${this.el.name}`),
                ...
                this.useLocalStorage &&
                    this.setLocalStorage(
                        this.fromLocalStorage() || this.value,
                        !0
                    );
        }
        fromLocalStorage() {
        ...
        setLocalStorage(e, r = !1) {
            (this.value === e && !r) ||
                (this.useLocalStorage &&
                    (window.localStorage[this.key] = e ? "true" : "false"),
                (this.value = e),
    ...
    var oe = class extends k {
        constructor(e) {
            super(e);
            this.useLocalStorage = typeof window.localStorage != "undefined";
            (this.heading = this.el.querySelectorAll(
                ".tsd-accordion-summary"
            )[0]),
                (this.body = this.el.querySelectorAll(
                ...
                (this.key = `tsd-accordion-${this.heading.textContent
                    ...
                    .toLowerCase()}`),
                this.useLocalStorage &&
                    (console.log("setting ", this.key, this.fromLocalStorage()),
                    this.setLocalStorage(this.fromLocalStorage(), !0)),
                this.heading.addEventListener("click", (r) =>
                    this.toggleVisibility(r)
                );
        }
        toggleVisibility(e) {
            e.preventDefault(),
        ...
        collapse() {
            let e = `${this.el.offsetHeight}px`,
                r = `${this.heading.offsetHeight}px`;
            this.animate(e, r, !1);
        }
        animate(e, r, n) {
        ...
        animationEnd(e, r) {
            (this.el.open = e),
                ...
                console.log("using storage", this.useLocalStorage),
                console.log("setting ", this.key, e),
                this.setLocalStorage(e),
                console.log("rfom storage", this.fromLocalStorage());
        }
        fromLocalStorage() {
    ...
    function Le(t) {
        ...
        (t.value = e),
            ...
            t.addEventListener("change", () => {
                localStorage.setItem("tsd-theme", t.value), Ee(t.value);
            });
    }
    function Ee(t) {
        switch (t) {
    ...
    D(re, ".tsd-signatures");
    D(ie, "a[data-toggle]");
    D(oe, ".tsd-index-accordion");
    D(se, ".tsd-filter-item input[type=checkbox]");
    var be = document.getElementById("theme");
    be && Le(be);
    var ze = new J();
    Object.defineProperty(window, "app", { value: ze });
})();
/*!
 * lunr.Builder
